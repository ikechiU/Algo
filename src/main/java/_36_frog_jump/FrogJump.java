...
* when all the positions from 1 to X are covered in leaves). You may assume that the speed of the current in the river
...
public class FrogJump {
    ...
    public static void main(String[] args) {
        ...
        System.out.println(solution(X1, A1));
    }
